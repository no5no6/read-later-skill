...
[English](#read-later-skill) | [中文](#中文说明)
...
当前仓库主要承载的是技能说明与参考文档，适合作为 Agent Skill / Prompt 规范仓库使用，而不是一个完整的运行时应用项目。
...
当前仓库以规范和参考资料为主，适合继续补充以下内容：

- 渠道接入示例，如 Telegram、Web Chat、CLI
- URL 规范化实现
- 摘要与标签生成策略
- MongoDB MCP 调用示例
- 自动化测试或脚本化校验
